...
import noProfile from "../../pages/Profile/assets/user.jpeg";

const Navbar = () => {
  const { user } = useContext(AuthContext);

  return (
    <div className="h-[50px] w-full bg-pink-600 flex items-center sticky top-0">
      ...
      >
        <div className="tabLinks text-lg cursor-pointer flex gap-[10px] ">
          ...
          <span className="tablink2 font-bold">Trending</span>
        </div>
