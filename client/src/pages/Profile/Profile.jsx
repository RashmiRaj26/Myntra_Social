...
//import coverImage from "./assets/myntra_img1.jpg";
...
import noProfilePic from "./assets/user.jpeg";
                  ...
                  {editMode ? (
                    ...
                    <>
                      <label
                        ...
                        className="text-white self-center cursor-pointer bg-pink-600 mt-2.5 px-5 py-2 rounded-md hover:bg-pink-700 transition"
                      >
                        Edit Profile
                      </label>
                      <input
